...
import 'deneme_sayfa_sablon_model.dart';
export 'deneme_sayfa_sablon_model.dart';

class DenemeSayfaSablonWidget extends StatefulWidget {
  const DenemeSayfaSablonWidget({Key? key}) : super(key: key);

  @override
  _DenemeSayfaSablonWidgetState createState() =>
      _DenemeSayfaSablonWidgetState();
}

class _DenemeSayfaSablonWidgetState extends State<DenemeSayfaSablonWidget> {
  late DenemeSayfaSablonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DenemeSayfaSablonModel());
  }
